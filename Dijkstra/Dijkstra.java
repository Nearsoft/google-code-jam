...
public class Dijkstra{
	...
	public Dijkstra(){
        ...
        for(int numberOfCase = 1; numberOfCase <= T; numberOfCase++){
            ...
            long L = Long.valueOf(splitted[0]);
            long X = Long.valueOf(splitted[1]);
            ...
            if(seekijk(word)) System.out.println("Case #" + numberOfCase + ": YES");
...
//        System.out.println("not for you sir");
        return false;
    }
    ...
    public String reduceWordTo1(String word) {
        ...
        String tmp = splitWord[0];
        
        for(long i = 1; i < word.length(); i++) {
            tmp = quaternionMult(tmp, splitWord[i]);  
        }
        return tmp;
    }
